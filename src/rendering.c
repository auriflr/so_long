...
/*   Updated: 2025/11/13 15:29:17 by afloris          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_graphics(t_game *game)
{
	...
	game->graphics->player = mlx_xpm_file_to_image(game->mlx,
			"graphics/player.xpm", &img_size, &img_size);
	...
	game->graphics->exit = mlx_xpm_file_to_image(game->mlx,
			"graphics/exit.xpm", &img_size, &img_size);
	...
	game->graphics->collect = mlx_xpm_file_to_image(game->mlx,
	...
	game->graphics->wall = mlx_xpm_file_to_image(game->mlx,
			"graphics/walls.xpm", &img_size, &img_size);
...
void	put_graphics(t_game *game, void *graphics, int x, int y)
{
	...
	mlx_put_image_to_window(game->mlx,
		game->window, graphics, (y * TILESIZE), (x * TILESIZE));
}
